        ...
        <div className="flex flex-col items-center justify-center border-2 gap-5 rounded-md p-6">
          ...
          <div className="my-4 w-full flex flex-col items-center">
            ...
            {qrData && (() => {
              ...
              if (!parsed.qrhash || !parsed.mercid) {
                return (
                  <div className="p-2 bg-yellow-100 rounded text-sm w-full break-words mb-2">
                    <strong>Warning:</strong> QR data does not contain a valid <code>qrhash</code>.
                  </div>
                );}
